...
public class DigestTest
{
    ...
    public void TestMD5HexShouldEqualToExpected()
    {
        ...
        string actual = Lib.Digestx.MD5Hex(Encoding.UTF8.GetBytes("wuriyanto"));
    ...
    public void TestMD5HexLongTextShouldEqualToExpected()
    {
        ...
        string actual = Lib.Digestx.MD5Hex(Encoding.UTF8.GetBytes("In cryptography, a hybrid cryptosystem is one which combines the convenience of a public-key cryptosystem with the efficiency of a symmetric-key cryptosystem.[1] Public-key cryptosystems are convenient in that they do not require"));
        Assert.Equal(expected.ToLower(), actual.ToLower());
    }
    ...
    public void TestSHA1HexShouldEqualToExpected()
    {
        ...
        string actual = Lib.Digestx.SHA1Hex(Encoding.UTF8.GetBytes("wuriyanto"));
        Assert.Equal(expected.ToLower(), actual.ToLower());
    }
    ...
    public void TestSHA1HexLongTextShouldEqualToExpected()
    {
        ...
        string actual = Lib.Digestx.SHA1Hex(Encoding.UTF8.GetBytes("In cryptography, a hybrid cryptosystem is one which combines the convenience of a public-key cryptosystem with the efficiency of a symmetric-key cryptosystem.[1] Public-key cryptosystems are convenient in that they do not require"));
        Assert.Equal(expected.ToLower(), actual.ToLower());
    }
    ...
    public void TestSHA256HexShouldEqualToExpected()
    {
        ...
        string actual = Lib.Digestx.SHA256Hex(Encoding.UTF8.GetBytes("wuriyanto"));
        Assert.Equal(expected.ToLower(), actual.ToLower());
    }
    ...
    public void TestSHA256HexLongTextShouldEqualToExpected()
    {
        ...
        string actual = Lib.Digestx.SHA256Hex(Encoding.UTF8.GetBytes("In cryptography, a hybrid cryptosystem is one which combines the convenience of a public-key cryptosystem with the efficiency of a symmetric-key cryptosystem.[1] Public-key cryptosystems are convenient in that they do not require"));
        Assert.Equal(expected.ToLower(), actual.ToLower());
    }
    ...
    public void TestSHA384HexShouldEqualToExpected()
    {
        ...
        string actual = Lib.Digestx.SHA384Hex(Encoding.UTF8.GetBytes("wuriyanto"));
        Assert.Equal(expected.ToLower(), actual.ToLower());
    }
    ...
    public void TestSHA384HexLongTextShouldEqualToExpected()
    {
        ...
        string actual = Lib.Digestx.SHA384Hex(Encoding.UTF8.GetBytes("In cryptography, a hybrid cryptosystem is one which combines the convenience of a public-key cryptosystem with the efficiency of a symmetric-key cryptosystem.[1] Public-key cryptosystems are convenient in that they do not require"));
        Assert.Equal(expected.ToLower(), actual.ToLower());
    }
    ...
    public void TestSHA512HexShouldEqualToExpected()
    {
        ...
        string actual = Lib.Digestx.SHA512Hex(Encoding.UTF8.GetBytes("wuriyanto"));
        Assert.Equal(expected.ToLower(), actual.ToLower());
    }
    ...
    public void TestSHA512HexLongTextShouldEqualToExpected()
    {
        ...
        string actual = Lib.Digestx.SHA512Hex(Encoding.UTF8.GetBytes("In cryptography, a hybrid cryptosystem is one which combines the convenience of a public-key cryptosystem with the efficiency of a symmetric-key cryptosystem.[1] Public-key cryptosystems are convenient in that they do not require"));
        Assert.Equal(expected.ToLower(), actual.ToLower());
    }
